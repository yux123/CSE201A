        ...
        <tr>
            ...
            <td class="style4" colspan="2">
                    ...
                    ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" Width="902px" 
                            ...
                            <ItemTemplate>
                            <asp:Image runat="server" ID="imff" ImageUrl='<%#Eval("img") %>' Height="50px" Width="45px" />
                            </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="ProductName" DataField="foodName" />
                            <asp:BoundField HeaderText="Price" DataField="price" />
                            <asp:TemplateField HeaderText="Count">
                            <ItemTemplate>
                            <asp:TextBox runat="server" name="txtq" class="txtCount" ID="txtq" Text='<%#Eval("foodCount") %>' Height="20px" Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="TotalPrice" DataField="totalprice" />
                            <asp:TemplateField HeaderText="Update">
                            <ItemTemplate>
                            <asp:LinkButton runat="server" Text="Update" ID="lnkupd" CommandName="update" ForeColor="Blue" CommandArgument='<%#Eval("id") %>'></asp:LinkButton>

                            </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Remove">
                            <ItemTemplate>
                            <asp:LinkButton runat="server" Text="Remove" ID="lnkrem" CommandName="Delete" ForeColor="Red" CommandArgument='<%#Eval("id") %>'></asp:LinkButton>
